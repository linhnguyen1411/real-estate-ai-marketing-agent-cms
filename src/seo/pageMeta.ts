...
export const STATIC_PAGES: PageMeta[] = [
  ...
  meta('/can-ho', 'Căn Hộ Đà Nẵng | Sun Group Ven Sông Hàn 2026', 'Căn hộ Sun Group ven sông Hàn và trung tâm Đà Nẵng — Symphony, Cosmo, cho thuê & đầu tư. Lọc theo giá, vị trí, pháp lý.'),
  meta('/dat-nen', 'Đất Nền Đà Nẵng | Nam Đà Nẵng & Mai Đăng Chơn 2026', 'Đất nền Nam Đà Nẵng, Mai Đăng Chơn, Hòa Xuân — pháp lý sổ hồng, giỏ ký gửi chính chủ cho đầu tư dài hạn.'),
